/*
 * MxmPalette.h - dummy class for fetching palette qproperties from CSS
 *                
 *
...
#ifndef MXM_GUI_MXM_PALETTE_H
#define MXM_GUI_MXM_PALETTE_H
...
class MXM_EXPORT MxmPalette : public QWidget
{
	Q_OBJECT
...
public:
	MxmPalette( QWidget * parent, QStyle * stylearg  ); 
	~MxmPalette() override = default;
