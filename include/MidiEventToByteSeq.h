...
#ifndef MXM_MIDIEVENTTOBYTESEQ_H
#define MXM_MIDIEVENTTOBYTESEQ_H
...
std::size_t MXM_EXPORT writeToByteSeq(const class MidiEvent& ev, uint8_t* data, std::size_t bufsize);

} // namespace mxm

#endif // MXM_MIDIEVENTTOBYTESEQ_H
