...
#ifndef MXM_GUI_INSTRUMENT_SOUND_SHAPING_VIEW_H
#define MXM_GUI_INSTRUMENT_SOUND_SHAPING_VIEW_H
...
namespace mxm { class InstrumentSoundShaping; }
...
#endif // MXM_GUI_INSTRUMENT_SOUND_SHAPING_VIEW_H
