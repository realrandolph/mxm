/*
 * mxm_constants.h - defines system constants
 *
...
#ifndef MXM_CONSTANTS_H
#define MXM_CONSTANTS_H
...
namespace mxm
{
// Prefer using `approximatelyEqual()` from mxm_math.h rather than
// using this directly
