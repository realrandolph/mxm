...
#ifndef MXM_HARDWARE_H
#define MXM_HARDWARE_H
...
#endif
#include "mxmconfig.h"
#if defined(MXM_HOST_X86_64) || defined(MXM_HOST_X86)
	#include <immintrin.h>
#elif defined(MXM_HOST_ARM64) || defined(MXM_HOST_ARM32)
	#if defined(__ARM_ACLE)
		#include <arm_acle.h>
	#elif defined(_MSC_VER)
		#include <intrin.h>
	#elif defined(__GNUG__) // HACK: Remove this once GCC properly provides __ARM_ACLE
		#if defined(MXM_HOST_ARM64)
...
#elif defined(MXM_HOST_X86_64) || defined(MXM_HOST_X86)
	64;
#elif defined(MXM_HOST_ARM64)
	256;
#elif defined(MXM_HOST_ARM32)
	64;
#elif defined(MXM_HOST_RISCV64) || defined(MXM_HOST_RISCV32)
	64;
...
#else
	64;
	#warning Defaulting to 64 for mxm::hardware_destructive_interference_size for this architecture. This may be incorrect.
#endif
...
#else
	// TODO MXM_HOST_PPC*
	#warning mxm::busyWaitHint() is not implemented on this architecture and will have no effect. Performance may suffer.
#endif
}
...
inline void disableDenormals()
{
	...
	#if defined(MXM_HOST_X86_64)
		_fxsave64(buf);
	#elif defined(MXM_HOST_X86)
		_fxsave(buf);
	#endif
	...
	#if defined(_MSC_VER) && defined(MXM_HOST_ARM64)
	...
	#elif defined(_MSC_VER) && defined(MXM_HOST_ARM32)
		// https://learn.microsoft.com/en-us/windows/arm/arm32-to-arm64
		// https://learn.microsoft.com/en-us/windows/whats-new/deprecated-features
		#warning MSVC for ARM32 is deprecated. mxm::disableDenormals() is not implemented and will have no effect.
	#elif defined(MXM_HOST_ARM64)
	...
	#endif
#else
	// TODO MXM_HOST_RISCV*: https://docs.riscv.org/reference/isa/unpriv/f-st-ext.html
	...
	// TODO MXM_HOST_PPC*: https://openpowerfoundation.org/specifications/isa
	...
	#warning mxm::disableDenormals() is not implemented on this architecture and will have no effect. Performance may suffer.
#endif
}

} // namespace mxm

#endif // MXM_HARDWARE_H
