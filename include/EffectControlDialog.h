...
#ifndef MXM_GUI_EFFECT_CONTROL_DIALOG_H
#define MXM_GUI_EFFECT_CONTROL_DIALOG_H
...
class MXM_EXPORT EffectControlDialog : public QWidget, public ModelView
{
public:
...
#endif // MXM_GUI_EFFECT_CONTROL_DIALOG_H
