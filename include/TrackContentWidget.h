...
#ifndef MXM_GUI_TRACK_CONTENT_WIDGET_H
#define MXM_GUI_TRACK_CONTENT_WIDGET_H
...
public slots:
	...
	void changePosition( const mxm::TimePos & newPos = TimePos( -1 ) );
...
#endif // MXM_GUI_TRACK_CONTENT_WIDGET_H
