							...
							LadspaPluginType _type )
{
	...
	connect( description, SIGNAL( doubleClicked( const ::mxm::ladspa_key_t & ) ),
				SLOT( showPorts( const ::mxm::ladspa_key_t & ) ) );
...
void LadspaBrowserView::showPorts( const ::mxm::ladspa_key_t & _key )
{
