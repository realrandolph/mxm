...
#ifndef MXM_AUDIO_FILE_PROCESSOR_WAVE_VIEW_H
#define MXM_AUDIO_FILE_PROCESSOR_WAVE_VIEW_H
...
public slots:
	...
	void isPlaying(mxm::f_cnt_t current_frame);
...
#endif // MXM_AUDIO_FILE_PROCESSOR_WAVE_VIEW_H
