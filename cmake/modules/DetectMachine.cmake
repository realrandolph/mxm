IF(WIN32)
	SET(MXM_BUILD_WIN32 1)
ELSEIF(APPLE)
	SET(MXM_BUILD_APPLE 1)
ELSEIF(${CMAKE_SYSTEM_NAME} MATCHES "OpenBSD")
	SET(MXM_BUILD_OPENBSD 1)
ELSEIF(${CMAKE_SYSTEM_NAME} MATCHES "FreeBSD")
	SET(MXM_BUILD_FREEBSD 1)
ELSEIF(HAIKU)
	SET(MXM_BUILD_HAIKU 1)
ELSEIF(CYGWIN)
	SET(MXM_BUILD_CYGWIN 1)
ELSE()
	SET(MXM_BUILD_LINUX 1)
ENDIF(WIN32)

MESSAGE("PROCESSOR: ${CMAKE_SYSTEM_PROCESSOR}")
SET(MXM_HOST_X86 FALSE)
SET(MXM_HOST_X86_64 FALSE)
SET(MXM_HOST_ARM32 FALSE)
SET(MXM_HOST_ARM64 FALSE)
SET(MXM_HOST_RISCV32 FALSE)
SET(MXM_HOST_RISCV64 FALSE)
...
IF(WIN32)
	if(MSVC)
		...
		if(MSVC_VER VERSION_GREATER_EQUAL 19.51)
			set(MXM_MSVC_GENERATOR "Visual Studio 18 2026")
			set(MXM_MSVC_YEAR 2026)
		else()
...
IF(MXM_BUILD_WIN32)
	...
	SET(DATA_DIR data)
	SET(MXM_DATA_DIR data)
ELSE(MXM_BUILD_WIN32)
	SET(BIN_DIR bin)
	SET(PLUGIN_DIR ${LIB_DIR}/mxm)
	SET(DATA_DIR share)
	SET(MXM_DATA_DIR ${DATA_DIR}/mxm)
